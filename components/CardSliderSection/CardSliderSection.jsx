...
import { cardSliderConatainerStyle, CardSliderSectionHeadingBoxStyles, CardSliderSectionHeadingStyles, sliderHeadingStyles, sliderTextStyles } from '@/styles/CardSliderStyles/CardSliderStyles';
                ...
                >
                    {
                        sliderCardDetails.slice(0, 5).map(({ cardImage, cardData, cardText, href }, ind) => (
                            <SwiperSlide key={ind} style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                <Link href={href} style={{ width: "100%", textDecoration: "none" }}>
                                    <Card sx={{
                                        ...
                                        <Box className="overlay"
                                            sx={{
                                                position: "absolute", width: "100%", height: "100%", background: "rgba(90, 34, 139, 0.25)", top: "0"
                                                , left: "0", opacity: 0
                                            }}>
