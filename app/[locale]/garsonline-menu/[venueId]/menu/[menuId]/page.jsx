                        ...
                        {sections?.data?.map((item, index) => {
                            return (
                                <Grid
                                    ...
                                    sx={{ textAlign: "center" }}
                                >
                                    <Box sx={{ marginTop: "10px", marginLeft: "10px", cursor: "pointer", background: "#ccc", width: "107px", height: "78px", borderRadius: "12px" }}>
                                            ...
                                            item?.items?.map((innerItem, innerIndex) => {
                                                return (
                                                    <Box sx={foodMenuCard} key={innerIndex}>
                                                        ...
                                                        <Box sx={{ marginLeft: "10px", cursor: "pointer", background: "#ccc", width: "100px", height: "100px", borderRadius: "12px" }}></Box>
                                                        {/* <Box>
                                                            <Image
